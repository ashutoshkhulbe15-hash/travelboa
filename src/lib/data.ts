...
export const SEARCH_DESTINATIONS = [
  ...DESTINATIONS.map(d => ({ name: d.name, slug: d.slug, info: d.info, color: d.color, type: d.type })),
  { name: "Valley of Flowers", slug: "valley-of-flowers", info: "3,658m · Uttarakhand", color: "#86198f", type: "adventure" as const },
  { name: "Badrinath", slug: "badrinath", info: "3,133m · Uttarakhand", color: "#6d28d9", type: "pilgrimage" as const },
  { name: "Rishikesh", slug: "rishikesh", info: "372m · Uttarakhand", color: "#059669", type: "adventure" as const },
];

export const GUIDES = [
  { title: "The complete Kedarnath trek guide for 2026", tag: "Trek", min: 12, rot: -1.5, href: "/kedarnath" },
  { title: "Spiti road trip: Manali to Shimla circuit", tag: "Road trip", min: 15, rot: 1, href: "/spiti" },
  { title: "What to pack for 4,000m+ altitude treks", tag: "Packing", min: 6, rot: -0.5, href: "/kedarnath/packing" },
  { title: "Best trekking shoes under ₹5,000 — tested", tag: "Gear", min: 6, rot: 1.5, href: "#" },
  { title: "Monsoon advisory: which routes to avoid", tag: "Safety", min: 4, rot: -1, href: "/road-status" },
  { title: "Vaishno Devi: tips nobody tells you", tag: "Pilgrimage", min: 8, rot: 0.8, href: "/vaishno-devi" },
] as const;
