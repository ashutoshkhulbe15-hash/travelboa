...
Plenty of dhabas on the trek route. Food is basic but safe (maggi, rice, dal, chai). Carry a water bottle — refill points are available but not filtered.`,
  ...
  checklist: [
    { category: "Clothing", items: [
      { name: "Thermal innerwear ×2", essential: true, affiliateLink: "https://amazon.in", affiliateStore: "Amazon", price: "₹799" },
      { name: "Fleece jacket", essential: true, affiliateLink: "https://amazon.in", affiliateStore: "Amazon", price: "₹1,499" },
      { name: "Windproof outer jacket", essential: true, affiliateLink: "https://decathlon.in", affiliateStore: "Decathlon", price: "₹2,999" },
      { name: "Trek pants ×2", essential: true },
      { name: "Warm socks ×3", essential: true, affiliateLink: "https://amazon.in", affiliateStore: "Amazon", price: "₹399" },
      { name: "Beanie / wool cap", essential: true },
      { name: "Gloves", essential: false, affiliateLink: "https://amazon.in", affiliateStore: "Amazon", price: "₹299" },
      { name: "Rain poncho", essential: true, affiliateLink: "https://amazon.in", affiliateStore: "Amazon", price: "₹249" },
      { name: "Sunglasses UV400", essential: true },
    ]},
    { category: "Gear", items: [
      { name: "Trekking shoes (broken in)", essential: true, affiliateLink: "https://decathlon.in", affiliateStore: "Decathlon", price: "₹3,999" },
      { name: "Day backpack 25–35L", essential: true, affiliateLink: "https://amazon.in", affiliateStore: "Amazon", price: "₹1,299" },
      { name: "Rain cover for backpack", essential: true },
      { name: "Walking stick / trekking pole", essential: false, affiliateLink: "https://decathlon.in", affiliateStore: "Decathlon", price: "₹999" },
      { name: "Headlamp / torch", essential: true, affiliateLink: "https://amazon.in", affiliateStore: "Amazon", price: "₹499" },
      { name: "Power bank 20,000 mAh", essential: true, affiliateLink: "https://amazon.in", affiliateStore: "Amazon", price: "₹1,499" },
    ...
    { category: "Health", items: [
      ...
      { name: "Sunscreen SPF 50+", essential: true, affiliateLink: "https://amazon.in", affiliateStore: "Amazon", price: "₹399" },
